...
<main>
  ...
  <p id="hint" style="text-align:center" class="${input.pushed ? '' : 'hidden'}">We sent it to your phone. Open Identizen to approve, or <a href="#" id="showqr">scan the code instead</a>.</p>
...
(function(){
  ...
  document.getElementById('showqr').onclick=function(e){e.preventDefault();qr.classList.remove('hidden');hint.classList.add('hidden');};
