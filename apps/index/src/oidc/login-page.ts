...
<main>
  ...
  <p id="hint" style="text-align:center" class="${input.pushed ? '' : 'hidden'}">We sent it to your phone. Approve there, or scan this code.</p>
  <div id="qr" class="qr">${qrSvg(input.deepLink)}</div>
