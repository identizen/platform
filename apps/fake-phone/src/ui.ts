...
<style>
:root{--s0:oklch(.995 .002 250);--s1:oklch(.975 .003 250);--fg:oklch(.2 .02 260);--muted:oklch(.48 .02 260);--border:oklch(.89 .006 250);--accent:oklch(.55 .19 30);--danger:oklch(.55 .21 15);--ok:oklch(.6 .16 155);color-scheme:light}
:root[data-theme=dark]{--s0:oklch(.17 .012 260);--s1:oklch(.2 .013 260);--fg:oklch(.96 .005 250);--muted:oklch(.72 .015 260);--border:oklch(.28 .014 260);--accent:oklch(.7 .17 30);--danger:oklch(.7 .18 15);--ok:oklch(.7 .15 155);color-scheme:dark}
@media(prefers-color-scheme:dark){:root:not([data-theme=light]){--s0:oklch(.17 .012 260);--s1:oklch(.2 .013 260);--fg:oklch(.96 .005 250);--muted:oklch(.72 .015 260);--border:oklch(.28 .014 260);--accent:oklch(.7 .17 30);--danger:oklch(.7 .18 15);--ok:oklch(.7 .15 155);color-scheme:dark}}
