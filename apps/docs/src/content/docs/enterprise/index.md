...
| Capability                     | Notes                                                                                                                                                                                                                  |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Invitation email               | The portal shows the invitation link once and the administrator sends it; delivery by email is next.                                                                                                                   |
| Enrollment policy              | Self-enrolment by verified email domain (the `auto_join` flag is stored today, not acted on), admin-issued enrollment links (email, MDM, help-desk QR), device attestation, admin approval or auto-approval by policy. |
| Fleet console                  | Enroll, disable, re-enroll, last-seen, attestation status, beyond the per-user device list the portal shows today.                                                                                                     |
| Policy                         | Require attestation, biometric class, geo/time rules, session max age, `allowed_amr`.                                                                                                                                  |
