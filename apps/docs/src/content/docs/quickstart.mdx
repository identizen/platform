...
4. **Log in**
   ...
   The iOS app is currently an internal build and is not yet on the App Store; use the fake phone from `identizen dev`, or the playground at https://identizen.com/playground. The [examples](/examples/) page lists sample apps you can run the same way.
