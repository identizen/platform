...
/**
 * Identizen ESLint flat config, shared by the open repo and every host that embeds the index.
 *
 * Enforces the frontend rules from the implementation plan:
...
export const defaultExportAllowed = [
...
/**
 * @param {{ tsconfigRootDir: string; ignores?: string[]; defaultExportAllowed?: string[] }} options
 */
export function identizenConfig(options) {
  return tseslint.config(
    ...
    {
      files: [...defaultExportAllowed, ...(options.defaultExportAllowed ?? [])],
